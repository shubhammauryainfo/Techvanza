...
const Dashlayout = ({ children }) => {
    ...
    const links = [
        ...
        { href: "/dashboard/products", label: "Products", icon: MdProductionQuantityLimits },
    ...
    return (
        <div className="flex">
            {/* Sidebar */}
            <div
                className={`fixed top-16 left-0 h-full bg-[#15142c] text-white shadow-lg z-50 transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
                    } w-64`}
            >
